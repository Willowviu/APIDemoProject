...
public class JiraTest {
	...
	public static void main(String[] args) {
		...
		//Add comment
		String addCommentResponse = given().pathParam("key", "10103").log().all().header("Content-Type","application/json").body("{\r\n"
		...
		//Get Issue
		String issueDetails = given().filter(session).pathParam("key", "10103")
